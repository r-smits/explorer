...
public:
  ...
  virtual MTL::RenderPipelineDescriptor *
  getRenderPipelineDescriptor(std::string path, std::string vertexFnName,
                              std::string fragmentFnName);
  virtual MTL::VertexDescriptor *getVertexDescriptor();
  virtual MTL::RenderPipelineState *
  getRenderPipelineState(std::string shaderName, bool serialize);
  virtual MTL::BinaryArchive *createBinaryArchive();
  virtual bool writeBinaryArchive(MTL::RenderPipelineDescriptor *,
                                  std::string path);
