...
public:
  ...
  static MTL::PrimitiveAccelerationStructureDescriptor* primitive(Explorer::Mesh* mesh, const int& stride);
  static NS::Array* primitives(Explorer::Model* model, const int& stride);
